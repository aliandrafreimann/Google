...
<form method="post" style="display: inline-block;">
    ...
    <input name="latitude" id="lat" placeholder="Laiuskraad">
    <input name="longitude" id="lng" placeholder="Laiuskraad2">
    <textarea name="description" placeholder="Kirjeldus"></textarea>
    <button name="action" value="Salvesta">Save</button>
</form>
